...
public class PushNotification {
    ...
    public static final String REST_API_KEY = "NWY3ZTMzNTctZjhjZi00OWU0LWJlMmUtYjFmZGViMDk0MTcw";
    public static final String APP_ID = "1b5bd5b8-5369-43b5-a60a-3e188ef6092b";
    public static void sendMessageToUser(String message, String userId,String data) {
        try {
            String jsonResponse;
